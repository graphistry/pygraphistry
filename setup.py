...
base_extras_heavy = {
  'umap-learn': ['umap-learn', 'dirty-cat==0.2.0', 'scikit-learn>=1.0','cu_cat @ git+http://github.com/graphistry/cu-cat.git@v0.06.2','psutil'],
}
...
# base_extras_heavy['ai'] = base_extras_heavy['ai'] + ['cu_cat @ git+http://github.com/graphistry/cu-cat.git@v0.06.0']
