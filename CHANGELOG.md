...
- **GFQL native types follow-on scoping (`#1046`)**: Added `ai/docs/gfql/scoping_1046_follow_on_slices.md` and linked it from the GFQL AI guide to define next executable child slices after internal T1-T5 completion, with concrete child issues `#1337` (public schema model), `#1338` (schema inference + typed topology), and `#1339` (public schema↔Arrow/plottable boundary APIs).
