...
- **GFQL / Cypher docs**: Added a dedicated local Cypher guide and helper reference, plus updated spec/reference docs to clarify direct local execution, helper APIs, and the current translation boundaries.
