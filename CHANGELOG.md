...
- Fixed potential None dereference crashes in DGL utilities and Sugiyama layout (#801)
  ...
  - Prevents TypeError crashes when optional attributes are None
  - Added regression tests in `test_dgl_none_dereference.py` and `test_sugiyama_none_dereference.py`
