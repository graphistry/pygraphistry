...
### Changed
- **GFQL CALL procedure implementation shrink (#1058)**: DRYed local Cypher CALL output-column derivation and NetworkX backend error/dependency plumbing, and delegated `graphistry.nx.pagerank` execution to NetworkX instead of maintaining a private PageRank copy. Public CALL procedure behavior and diagnostics are preserved.
