...
- GFQL: record whole-entity projection provenance independently of identity columns, so adapters can distinguish unlabeled entities from property returns (tck-gfql#200).
