...
2. Verify that your process succeeds by pulling down the `nvidia/cuda:7.5-devel` image and running
    ...
    ```
3. Run through the four commands at [https://github.com/graphistry/infrastructure/blob/d8feb37ea6f38faa0ce21c75f7f8e581142b456e/nvidia-docker-host/roles/nvidiadocker/tasks/main.yml#L10-L20](https://github.com/graphistry/infrastructure/blob/d8feb37ea6f38faa0ce21c75f7f8e581142b456e/nvidia-docker-host/roles/nvidiadocker/tasks/main.yml#L10-L20) to verify that the nvidia-docker works using our *cljs* test demo.
