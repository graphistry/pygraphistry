...
### PyGraphistry Client - pip install

`pip install` the client in your notebook or web app, and then connect to a [free Graphistry Hub account](https://www.graphistry.com/get-started) or [launch your own private GPU server](https://www.graphistry.com/get-started)
...
* [Pandas](https://pandas.pydata.org) and [cuDF](https://www.rapids.ai) dataframes from CSV, txt, JSON, parquet, arrow, ORC, and more
...
## Access control for sharing visualizations
