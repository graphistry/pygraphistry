...
nitpick_ignore = [
    ...
    ('py:class', 'graphistry.plugins_types.graphviz_types.EdgeAttr'),
    ('py:class', 'graphistry.plugins_types.graphviz_types.Format'),
    ('py:class', 'graphistry.plugins_types.graphviz_types.GraphAttr'),
    ('py:class', 'graphistry.plugins_types.graphviz_types.NodeAttr'),
    ('py:class', 'graphistry.plugins_types.graphviz_types.Prog'),
