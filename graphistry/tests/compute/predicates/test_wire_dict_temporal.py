...
from graphistry.compute.predicates import gt, lt, ge, le, eq, ne, between, is_in
...
class TestWireProtocolDicts:
    ...
    def test_datetime_wire_dict(self):
        ...
        df = pd.DataFrame({
            'timestamp': pd.date_range('2023-01-01', periods=5, freq='D', tz='UTC')
        })
        
        # Test with gt
        wire_dict = {"type": "datetime", "value": "2023-01-03T00:00:00", "timezone": "UTC"}
        pred = gt(wire_dict)
        result = pred(df['timestamp'])
        assert result.tolist() == [False, False, False, True, True]
        
        # Test with between
        start_dict = {"type": "datetime", "value": "2023-01-02T00:00:00", "timezone": "UTC"}
        end_dict = {"type": "datetime", "value": "2023-01-04T00:00:00", "timezone": "UTC"}
    ...
    def test_is_in_wire_dicts(self):
        ...
        wire_dicts = [
            {"type": "datetime", "value": "2023-01-02T00:00:00", "timezone": "UTC"},
            {"type": "datetime", "value": "2023-01-04T00:00:00", "timezone": "UTC"}
        ]
    ...
    def test_wire_dict_serialization(self):
        ...
        wire_dict = {"type": "datetime", "value": "2023-01-01T00:00:00", "timezone": "UTC"}
        pred = gt(wire_dict)
    ...
    def test_mixed_types_with_wire_dicts(self):
        ...
        # Can use wire dict for temporal and regular value for numeric
