...
class TestComputeCluster(unittest.TestCase):
    ...
    def test_dbscan_params(self):
        dbscan_params = [ModelDict('Testing UMAP', kind='nodes', eps=0.2, min_samples=1, cols=None, target=False, 
                                   fit_umap_embedding=False, verbose=True), 
                         ModelDict('Testing UMAP target', kind='nodes', eps=0.1, min_samples=1, cols=None, 
