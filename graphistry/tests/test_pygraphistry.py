...
class TestPyGraphistry_Auth(unittest.TestCase):
    ...
    def test_overrides(self):
        pyg1 = PyGraphistry().register(store_token_creds_in_memory=None)
        assert pyg1.store_token_creds_in_memory() is True
        pyg2 = PyGraphistry().register(store_token_creds_in_memory=False)
        assert pyg2.store_token_creds_in_memory() is False
