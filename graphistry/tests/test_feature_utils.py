...
class TestFeatureProcessors(unittest.TestCase):
    def cases_tests(self, x, y, data_encoder, target_encoder, name, value):
        ...
        self.assertIsInstance(
            ...
            f"Data Encoder is not a dirty_cat.table_vectorizer.TableVectorizer instance for {name} {value}",
        )
        self.assertIsInstance(
            target_encoder,
            dirty_cat.table_vectorizer.TableVectorizer,
            f"Data Target Encoder is not a dirty_cat.table_vectorizer.TableVectorizer instance for {name} {value}",
        )
