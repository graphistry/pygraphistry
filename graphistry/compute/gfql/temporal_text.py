...
# Compatibility facade: keep the historical temporal_text import path stable
# while domain-specific implementation lives under graphistry.compute.gfql.temporal.
...
from graphistry.compute.gfql.temporal.truncation import (  # noqa: E402
...
from graphistry.compute.gfql.temporal.rendering import _render_temporal_arg  # noqa: E402
from graphistry.compute.gfql.temporal.folding import (  # noqa: E402
