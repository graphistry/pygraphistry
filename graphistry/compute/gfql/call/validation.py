...
SAFELIST_V1: Dict[str, Dict[str, Any]] = {
    ...
    'encode_point_size': _numeric_encode_method(
        'Map node column values to sizes',
        NODE_COLUMN_SCHEMA_EFFECTS,
    ),

    'encode_edge_size': _numeric_encode_method(
        'Map edge column values to sizes',
        EDGE_COLUMN_SCHEMA_EFFECTS,
    ),

    'encode_edge_weight': _numeric_encode_method(
        'Map edge column values to weights',
        EDGE_COLUMN_SCHEMA_EFFECTS,
    ),

    'encode_point_opacity': _numeric_encode_method(
        'Map node column values to opacity',
        NODE_COLUMN_SCHEMA_EFFECTS,
    ),

    'encode_edge_opacity': _numeric_encode_method(
        'Map edge column values to opacity',
        EDGE_COLUMN_SCHEMA_EFFECTS,
    ),

    'encode_point_label': _column_encode_method(
        'Bind node label column',
        NODE_COLUMN_SCHEMA_EFFECTS,
    ),

    'encode_edge_label': _column_encode_method(
        'Bind edge label column',
        EDGE_COLUMN_SCHEMA_EFFECTS,
    ),

    'encode_point_title': _column_encode_method(
        'Bind node title column',
        NODE_COLUMN_SCHEMA_EFFECTS,
    ),

    'encode_edge_title': _column_encode_method(
        'Bind edge title column',
        EDGE_COLUMN_SCHEMA_EFFECTS,
    ),
