"""
Server dataset endpoint payload contract types.

Separated from `graphistry.io.types` so Plottable metadata serde types stay
focused and server response contract evolution is isolated.
"""
