...
- [`scoping_1046_follow_on_slices.md`](./scoping_1046_follow_on_slices.md) — Follow-on child-slice plan for finishing the public-facing parts of GFQL native typing.
